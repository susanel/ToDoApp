...
const inputSearchTask = document.querySelector(
...
const countPercentage = () => {
  const allTasksNr = pendingTasksArray.length + completedTasksArray.length;
...
const searchTask = (e) => {
  ...
  const tasks = pendingTasksArray.filter((li) =>
  ...
  const tasksCompleted = completedTasksArray.filter((li) =>
    li.textContent.toLowerCase().includes(searchText)
  );
  ulCompleted.textContent = "";
...
const addCompletedTask = (e) => {
  ...
  if (completedTask.classList.contains("completed")) {
    ...
    completedTask
      ...
      .addEventListener("click", addCompletedTask);
...
document.querySelector("button.stats").addEventListener("click", generateModal);

document.querySelector("div.hide").addEventListener("click", () => {
